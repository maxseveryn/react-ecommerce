        ...
        <div className="product-info">
          <div className="product-description">
            ...
            <p className="product-description--value">
              ...
              iusto ad quibusdam esse, voluptates, ipsa repellendus impedit vel
              odit perspiciatis natus fugit sunt quae sit veniam aliquid
              temporibus reiciendis dolorem!
            </p>
            <hr />
