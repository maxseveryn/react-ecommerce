...
export default function ShoppingCart({ onClose, checkout }) {
  const cart = useContext(CartContext);

  const { products } = useProducts();

  const subtotal = cart.getSubtotalCost();
  const vat = cart.getVatCost();
    ...
    <div className="shopping-cart">
      ...
      {cart.items.length === 0 ? (
        <div className="shopping-cart__empty">
          ...
          <Link
            to="/"
            className="shopping-cart__empty-button"
            onClick={onClose}
          >
            Go Shopping
          </Link>
        ...
        <>
          ...
          <div className="shopping-cart__info">
            ...
            <div className="shopping-cart__info-row">
              <p>Shipping</p>
              <p className="shopping-cart__info--shipping">${shipping}</p>
            </div>
            <div className="shopping-cart__info-row">
              <p>VAT(20%)</p>
